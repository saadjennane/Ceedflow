    ...
    <div className="min-h-screen relative overflow-hidden bg-black text-white flex flex-col">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 py-5">
        <Link href="/" className="flex items-center">
          <img src="/Logos/logo builders-01.png" alt="The Builders" className="h-7 md:h-9 w-auto" />
        </Link>
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center max-w-7xl w-full mx-auto px-6 md:px-12 py-6">
        <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white mb-3 animate-fade-up opacity-0" style={{ animationDelay: '0s' }}>
          The Builders
        </div>
